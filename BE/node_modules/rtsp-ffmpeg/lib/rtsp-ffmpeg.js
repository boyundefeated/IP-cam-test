...
FFMpeg.prototype.start = function() {
	...
	var myArg = '-rtsp_transport tcp -loglevel quiet -i rtsp://192.168.1.122:554/ -f image2pipe -vcodec png -vf fps=fps=1 -qscale:v 4 -huffman optimal -s 200x200 -'.split(' ');
	this.child = spawn(FFMpeg.cmd, myArg);
